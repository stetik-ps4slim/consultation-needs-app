        ...
        <header className="rounded-[2rem] border border-white/70 bg-white/90 p-6 shadow-[0_24px_90px_rgba(0,0,0,0.08)] backdrop-blur-xl sm:p-8">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1">
              ...
              <a href="/active-clients" className="shrink-0 rounded-full border border-stone-200 bg-white px-4 py-2.5 text-sm font-semibold text-[#15314a] transition hover:border-[#9a6820]/60">
                Active Clients
              </a>
              <button
                type="button"
